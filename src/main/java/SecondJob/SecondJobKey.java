...
public class SecondJobKey implements WritableComparable<SecondJobKey>{
	...
	public SecondJobKey(String w1, String w2, int decade) {
	...
	@Override
	public int compareTo(SecondJobKey o) {
...
//	}	
//        if(this.decade.get() - o.decade.get() == 0) {
...
//        }
//        return this.decade.get() - o.decade.get();
//	}
//	
